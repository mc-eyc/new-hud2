export default function demo(store) {
  ...
  store.dispatch({ type: "balances.add", balance: { title: "Win", value: "$999,999,999.99" }});
  store.dispatch({ type: "balances.add", balance: { title: "Bet", value: "$999,999,999.99" }});
  store.dispatch({ type: "balances.add", balance: { title: "Free Games", value: "0" }});
